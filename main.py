...
import numpy as np
import os
from engines.Model_Structure import Model_Structure
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Tuning with Glove/SciBERT-CNN-BiLSTM-SA-CRF')
    ...
    if mode == 'api_service':
        ...
        model = Model_Structure(configs, logger, dataManager)
        if mode == 'train':
